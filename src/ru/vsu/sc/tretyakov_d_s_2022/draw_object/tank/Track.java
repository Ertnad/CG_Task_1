...
public class Track extends DrawingObject {


    public Track(double posCofX, double posCofY, double sizeCofX, double sizeCofY, Color color) {
    ...
    public void draw(Graphics2D gr2d, int windowCurrWidth, int windowCurrHeight) {
        drawWithColor(gr2d, this.color, () -> gr2d.fillRoundRect(
                ...
                (int) (((sizeCofX / 4) * windowCurrWidth)),
                (int) (sizeCofY * windowCurrHeight)
        ));
